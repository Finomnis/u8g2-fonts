...
fn letters_not_supported() {
    ...
    let result = fonts::u8g2_font_courB10_tn.render(
        'a',
        Point::new(2, 15),
...
fn unicode_not_supported() {
    ...
    let result = (fonts::u8g2_font_lubBI08_tf).render(
        '☃',
        Point::new(2, 15),
        VerticalPosition::default(),
        FontColor::Transparent(Rgb888::new(237, 28, 36)),
...
fn background_color_not_supported() {
    ...
    let result1 = (fonts::u8g2_font_lubBI08_tf).render(
        'a',
        Point::default(),
        VerticalPosition::default(),
    ...
    let result2 = (fonts::u8g2_font_lubBI08_tf).render_aligned(
        'a',
        Point::default(),
        VerticalPosition::default(),
...
fn get_font_bounding_box() {
    ...
    assert_eq!(
        font.get_font_bounding_box(VerticalPosition::Top),
        Rectangle::new(Point::new(-1, -6), Size::new(31, 36))
    );
    assert_eq!(
        font.get_font_bounding_box(VerticalPosition::Center),
        Rectangle::new(Point::new(-1, -21), Size::new(31, 36))
    );
    assert_eq!(
        font.get_font_bounding_box(VerticalPosition::Bottom),
...
fn render_glyph_unicode() {
    let dimensions = TestDrawTarget::expect_image(
        ...
        |display| {
            (fonts::u8g2_font_unifont_t_symbols)
                .render(
                    '☃',
                    Point::new(4, 19),
                    VerticalPosition::default(),
...
fn aligned_text_with_ignore_unknown() {
    let text = "☃A☃g☃i☃,☃\n☃i☃a☃g☃m☃A☃!☃";
    let font = (fonts::u8g2_font_ncenB14_tr).with_ignore_unknown_chars(true);
